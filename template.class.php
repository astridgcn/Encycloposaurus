...
class Template {
	 ...
	 *
	 */
	function Templateconstruct($root = "./")
	{
	...
	function assign_var_from_handle($varname, $handle)
	{
		if (!$this->loadfile($handle))
		{
			die("Template->assign_var_from_handle(): Impossible de charger le fichier template pour le mod�le $handle");
		}
	...
	function loadfile($handle)
	{
		...
		{
			die("Template->loadfile(): Aucun fichier sp�cifi� pour le mod�le $handle");
		}
		...
		if (empty($str))
		{
			die("Template->loadfile(): Le fichier $filename pour le mod�le $handle est vide");
		}
